...
class TodoApp:
    def __init__(self, root):
        ...
        self.root.geometry("500x500") # Changed * to x
        self.root.resizable(False, False) # Fixed spelling
        self.root.configure(bg="#f0f4f7")
        
        self.tasks = [] # Fixed variable name to match the rest of the code
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        self.task_entry.pack(side="left", padx=(0, 10)) # Fixed "slide" to "side"
        ...
        # Fixed the comma at the end of this line
        ...
        self.task_listbox.pack(side="left", fill="both", expand=True, padx=(10,0))
        ...
        self.info_label = tk.Label(
            ...
            font=("Helvetica", 11),
            bg="#f0f4f7",
            fg="#2ecc71", # Changed color slightly for readability
        )
        ...
        delete_button = tk.Button(
            button_frame, # Added frame parent
            text="Delete Task",
            font=("Helvetica", 11, "bold", "italic"),
            bg="#c0392d",
            fg="white",
    ...
    def refresh_listbox(self): # Fixed name and indentation
    ...
    def add_task(self):
        ...
        self.info_label.config(text=f"Task added!")
        self.refresh_listbox()
    
    def get_selected_index(self):
        selection = self.task_listbox.curselection() # Fixed "task_listner"
        if not selection:
    ...
    def delete_task(self):
        ...
        self.refresh_listbox() # Added brackets to call function
